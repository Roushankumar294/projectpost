...
<form:form method="post" action="/SpringDemo/updatesuccess">    
        <table>    
         ...
         <tr>    
          ...
          <form:input path="p_name" placeholder="p_name"/>
          </div>
          </td>  
         </tr>   
         <tr>    
          ...
          <form:input path="p_price" placeholder="p_price"/>
          </div>
          </td>  
         </tr>   
         <tr>    
          ...
          <form:input path="p_brand" placeholder="p_brand"/>
          </div>
          </td>  
         </tr>   
         <tr>    
          ...
          <div class="input-group" style="width:300px;">
  			<span class="input-group-addon"style="color:green;"> <i class="glyphicon glyphicon-home"></i></span>
          <form:input path="p_description" placeholder="p_description"/>
          </div>
          </td>  
         </tr>
         <tr>
         <td>supplier
         <form:select path="supplier_name"><br>
		 ...
		 <tr>
         <td>category
         <form:select path="category_name"><br>
         <form:option value="none"/>
         <form:options items="${CategoryName}"/>
          ...
          <div class="input-group" style="width:300px;">
  			<span class="input-group-addon"style="color:green;"> <i class="glyphicon glyphicon-home"></i></span>
          <form:input path="p_quantity" placeholder="p_quantity"/>
          </div>
          </td>  
         </tr>
        </table>   
