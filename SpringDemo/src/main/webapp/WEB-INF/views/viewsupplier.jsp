...
<marquee><h1 style="color:red;">welcome to Supplier information</h1></marquee>
 ...
 <th>id</th>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
<tr>
 <c:forEach var="i" items="${supplierdata}">
 <tr>
 <td>${i.id}</td>
 <td>${i.name}</td>
 <td>${i.description}</td>
  <td>${i.address}&nbsp;&nbsp;</td>
  <td><a href="/SpringDemo/getupdateSupplierdata/${i.id}" style="color:blue;">&nbsp;&nbsp;
     <span class="glyphicon glyphicon-pencil"  style="color:red;font-size:16px;"></span>
</a></td>
   <td><a href="supplierdelete/${i.id}" style="color:red;font-size:16px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
